...
public class QiniuUtils {
    ...
    private static void testUpload() {
        ...
        UploadManager uploadManager = new UploadManager(cfg);
        //...生成上传凭证，然后准备上传
        String accessKey = "CYddIERSeFLYRhAmv2N_BldHnfz5S0MTgciL_Ysi";
        String secretKey = "O1qRltxc4CsIY8J-sj4OcdeSaaWaX326MMNrZAA-";
        String bucket = "bigshen";
        //默认不指定key的情况下，以文件内容的hash值作为文件名
        String key = UUID.randomUUID().toString() + ".png";
        FileInputStream fileInputStream = null;
        try {

            String filePath = "E:\\develop\\1.png";
...
//            byte[] uploadBytes = "hello qiniu cloud".getBytes("utf-8");
    ...
    private static void getdownloadurl() throws UnsupportedEncodingException {
        String fileName = "3421f8b7-72bd-4099-ad09-183786680664.png";
        String domainOfBucket = "http://q7vtfkg8m.bkt.clouddn.com";
